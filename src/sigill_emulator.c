...
static void emulate_aesdec(uint8_t *dest, const uint8_t *key) {
    simde__m128i a = simde_mm_loadu_si128((const simde__m128i *)dest);
    simde__m128i k = simde_mm_loadu_si128((const simde__m128i *)key);
    simde__m128i res = simde_mm_aesdec_si128(a, k);
    simde_mm_storeu_si128((simde__m128i *)dest, res);
}

static void emulate_aesdeclast(uint8_t *dest, const uint8_t *key) {
    simde__m128i a = simde_mm_loadu_si128((const simde__m128i *)dest);
    simde__m128i k = simde_mm_loadu_si128((const simde__m128i *)key);
    simde__m128i res = simde_mm_aesdeclast_si128(a, k);
    simde_mm_storeu_si128((simde__m128i *)dest, res);
}
...
static void emulate_aesenc(uint8_t *dest, const uint8_t *key) {
    simde__m128i a = simde_mm_loadu_si128((const simde__m128i *)dest);
    simde__m128i k = simde_mm_loadu_si128((const simde__m128i *)key);
    simde__m128i res = simde_mm_aesenc_si128(a, k);
    simde_mm_storeu_si128((simde__m128i *)dest, res);
}
...
static void emulate_aesenclast(uint8_t *dest, const uint8_t *key) {
    simde__m128i a = simde_mm_loadu_si128((const simde__m128i *)dest);
    simde__m128i k = simde_mm_loadu_si128((const simde__m128i *)key);
    simde__m128i res = simde_mm_aesenclast_si128(a, k);
    simde_mm_storeu_si128((simde__m128i *)dest, res);
}

static void emulate_aesimc(uint8_t *dest, const uint8_t *src) {
    simde__m128i s = simde_mm_loadu_si128((const simde__m128i *)src);
    simde__m128i res = simde_mm_aesimc_si128(s);
    simde_mm_storeu_si128((simde__m128i *)dest, res);
}
